...
weight_file = '/home/harsha/Machine_Learning_Project/Models/AutoEncoder_Weights/Mix_Data_Weights/31st_August/Batch_Size_100/weights-improvement-92-0.98.hdf5'

print("Loading Weights ....")
model.load_weights(weight_file)

data_file = '/home/harsha/Machine_Learning_Project/Dataset/default of credit card clients.csv'
...
data_0 = np.array(data_0.iloc[:,:])
data_1 = np.array(data_1.iloc[:,:])
